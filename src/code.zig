...
pub const Codes: [std.math.maxInt(u8)]Code = init: {
    const codes = [_]Code{
        ...
        Code.init(0x0A, CodeType.ASL, 2, AddressingMode.None),
        ...
        Code.init(0xB5, CodeType.LDA, 4, AddressingMode.ZeroPageX),
        ...
        Code.init(0x4A, CodeType.LSR, 2, AddressingMode.None),
        ...
        // push to stack
        Code.init(0x48, CodeType.PHA, 3, AddressingMode.None),
        Code.init(0x08, CodeType.PHP, 3, AddressingMode.None),
        Code.init(0x68, CodeType.PLA, 4, AddressingMode.None),
        Code.init(0x28, CodeType.PLP, 4, AddressingMode.None),
        ...
        // Code.init(0x76, CodeType.ROR, 6, AddressingMode.ZeroPageX),
        // Code.init(0x6E, CodeType.ROR, 6, AddressingMode.Absolute),
        // Code.init(0x7E, CodeType.ROR, 7, AddressingMode.AbsoluteX),

        // return
        Code.init(0x40, CodeType.RTI, 6, AddressingMode.None),
        Code.init(0x60, CodeType.RTS, 6, AddressingMode.None),
        ...
        // transfer
        Code.init(0xAA, CodeType.TAX, 2, AddressingMode.None),
        Code.init(0xA8, CodeType.TAY, 2, AddressingMode.None),
        Code.init(0xBA, CodeType.TSX, 2, AddressingMode.None),
        Code.init(0x8A, CodeType.TXA, 2, AddressingMode.None),
        Code.init(0x9A, CodeType.TXS, 2, AddressingMode.None),
